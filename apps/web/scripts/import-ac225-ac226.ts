...
import AC225 from '../lib/models/AC225.js';
import AC226 from '../lib/models/AC226.js';
...
async function importData() {
  try {
    ...
    // File path for AC225 and AC226.xlsx
    const filePath = '/Users/santhoshraja/Santhosh/Web Application/tuticorin-gov-app/AC225 and AC226.xlsx';

    if (!fs.existsSync(filePath)) {
      throw new Error(
        `File not found: ${filePath}\nPlease ensure "AC225 and AC226.xlsx" exists at the specified path.`
      );
    }
    ...
    // Import AC225 sheet
    await importSheetData(workbook, 'AC225', AC225, 'AC225');

    // Import AC226 sheet
    await importSheetData(workbook, 'AC226', AC226, 'AC226');
