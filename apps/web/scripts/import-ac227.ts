...
import AC227 from '../lib/models/AC227.js';
...
async function importData() {
  try {
    ...
    // File path for AC227.xlsx
    const filePath = '/Users/santhoshraja/Santhosh/Web Application/tuticorin-gov-app/AC227.xlsx';

    if (!fs.existsSync(filePath)) {
      throw new Error(
        `File not found: ${filePath}\nPlease ensure "AC227.xlsx" exists at the specified path.`
      );
    }
    ...
    // Import AC227 sheet
    await importSheetData(workbook, 'AC227', AC227, 'AC227');
