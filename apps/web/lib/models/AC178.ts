...
export interface IAC178 extends Document {
  acNo: number;
  partNo: number;
  slNoInPart: number;
  houseNo?: string;
...
const AC178Schema: Schema = new Schema(
  {
...
AC178Schema.index({ acNo: 1, partNo: 1 });
AC178Schema.index({ houseNo: 1, sectionNo: 1 });
AC178Schema.index({ fmNameV2: 'text', rlnFmNmV2: 'text', fmNameEn: 'text', rlnFmNmEn: 'text' });

export default mongoose.models.AC178 || mongoose.model<IAC178>('AC178', AC178Schema);
