...
export interface IAC177 extends Document {
  acNo: number;
  partNo: number;
  slNoInPart: number;
  houseNo?: string;
...
const AC177Schema: Schema = new Schema(
  {
...
AC177Schema.index({ acNo: 1, partNo: 1 });
AC177Schema.index({ houseNo: 1, sectionNo: 1 });
AC177Schema.index({
  fmNameV2: "text",
  rlnFmNmV2: "text",
  fmNameEn: "text",
...
export default mongoose.models.AC177 ||
  mongoose.model<IAC177>("AC177", AC177Schema);
