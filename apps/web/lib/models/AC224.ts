...
export interface IAC224 extends Document {
  acNo: number;
  partNo: number;
  slNoInPart: number;
  houseNo?: string;
...
const AC224Schema: Schema = new Schema(
  {
...
AC224Schema.index({ acNo: 1, partNo: 1 });
AC224Schema.index({ houseNo: 1, sectionNo: 1 });
AC224Schema.index({ fmNameV2: 'text', rlnFmNmV2: 'text', fmNameEn: 'text', rlnFmNmEn: 'text' });

export default mongoose.models.AC224 || mongoose.model<IAC224>('AC224', AC224Schema);
