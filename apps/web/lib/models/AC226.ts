...
export interface IAC226 extends Document {
  acNo: number;
  partNo: number;
  slNoInPart: number;
  houseNo?: string;
...
const AC226Schema: Schema = new Schema(
  {
...
AC226Schema.index({ acNo: 1, partNo: 1 });
AC226Schema.index({ houseNo: 1, sectionNo: 1 });
AC226Schema.index({ fmNameV2: 'text', rlnFmNmV2: 'text', fmNameEn: 'text', rlnFmNmEn: 'text' });

export default mongoose.models.AC226 || mongoose.model<IAC226>('AC226', AC226Schema);
