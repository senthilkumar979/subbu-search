...
export interface IAC227 extends Document {
  acNo: number;
  partNo: number;
  slNoInPart: number;
  houseNo?: string;
...
const AC227Schema: Schema = new Schema(
  {
...
AC227Schema.index({ acNo: 1, partNo: 1 });
AC227Schema.index({ houseNo: 1, sectionNo: 1 });
AC227Schema.index({ fmNameV2: 'text', rlnFmNmV2: 'text', fmNameEn: 'text', rlnFmNmEn: 'text' });

export default mongoose.models.AC227 || mongoose.model<IAC227>('AC227', AC227Schema);
