...
export interface IAC225 extends Document {
  acNo: number;
  partNo: number;
  slNoInPart: number;
  houseNo?: string;
...
const AC225Schema: Schema = new Schema(
  {
...
AC225Schema.index({ acNo: 1, partNo: 1 });
AC225Schema.index({ houseNo: 1, sectionNo: 1 });
AC225Schema.index({ fmNameV2: 'text', rlnFmNmV2: 'text', fmNameEn: 'text', rlnFmNmEn: 'text' });

export default mongoose.models.AC225 || mongoose.model<IAC225>('AC225', AC225Schema);
