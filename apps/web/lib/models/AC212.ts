...
export interface IAC212 extends Document {
  acNo: number;
  partNo: number;
  slNoInPart: number;
  houseNo?: string;
...
const AC212Schema: Schema = new Schema(
  {
...
AC212Schema.index({ acNo: 1, partNo: 1 });
AC212Schema.index({ houseNo: 1, sectionNo: 1 });
AC212Schema.index({ fmNameV2: 'text', rlnFmNmV2: 'text', fmNameEn: 'text', rlnFmNmEn: 'text' });

export default mongoose.models.AC212 || mongoose.model<IAC212>('AC212', AC212Schema);
