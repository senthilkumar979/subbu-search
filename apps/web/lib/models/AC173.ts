...
export interface IAC173 extends Document {
  acNo: number;
  partNo: number;
  slNoInPart: number;
  houseNo?: string;
...
const AC173Schema: Schema = new Schema(
  {
...
AC173Schema.index({ acNo: 1, partNo: 1 });
AC173Schema.index({ houseNo: 1, sectionNo: 1 });
AC173Schema.index({ fmNameV2: 'text', rlnFmNmV2: 'text', fmNameEn: 'text', rlnFmNmEn: 'text' });

export default mongoose.models.AC173 || mongoose.model<IAC173>('AC173', AC173Schema);
