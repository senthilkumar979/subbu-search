...
export interface IAC210 extends Document {
  acNo: number;
  partNo: number;
  slNoInPart: number;
  houseNo?: string;
...
const AC210Schema: Schema = new Schema(
  {
...
AC210Schema.index({ acNo: 1, partNo: 1 });
AC210Schema.index({ houseNo: 1, sectionNo: 1 });
AC210Schema.index({ fmNameV2: 'text', rlnFmNmV2: 'text', fmNameEn: 'text', rlnFmNmEn: 'text' });

export default mongoose.models.AC210 || mongoose.model<IAC210>('AC210', AC210Schema);
