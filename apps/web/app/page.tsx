          ...
          <div className="max-w-5xl mx-auto">
            ...
            <div className="grid grid-cols-2 lg:grid-cols-3 gap-4">
              ...
              >
                ...
                <div className="text-gray-700 font-medium">Tiruvarur</div>
                <div className="text-gray-600 text-sm mt-1">திருவாரூர்</div>
              </button>
              <button
                onClick={() => handleSelectConstituency("AC177")}
                className="bg-white hover:bg-blue-50 border-2 border-gray-200 hover:border-blue-400 rounded-lg p-6 text-left transition-all duration-200 shadow-sm hover:shadow-md"
              >
                <div className="text-xl font-bold text-blue-900 mb-1">
                  AC 177
              ...
              <button
                onClick={() => handleSelectConstituency("AC178")}
                className="bg-white hover:bg-blue-50 border-2 border-gray-200 hover:border-blue-400 rounded-lg p-6 text-left transition-all duration-200 shadow-sm hover:shadow-md"
              >
                <div className="text-xl font-bold text-blue-900 mb-1">
                  AC 178
                </div>
                <div className="text-gray-700 font-medium">Mannargudi</div>
                <div className="text-gray-600 text-sm mt-1">மன்னார்குடி</div>
              </button>
            </div>
          </div>
        </div>
            ...
            <div className="p-8 lg:p-12 text-center">
              <div className="max-w-5xl mx-auto">
                ...
                <h3 className="text-xl font-semibold text-gray-900 mb-6">
                  வாக்காளர் பட்டியல் தேடல் - 2002 தரவு / Search Electoral Roll -
                  2002 Data
                </h3>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 text-left">
                  ...
                  <div className="space-y-3 text-sm text-gray-600">
                    <p className="font-medium text-center mb-4">
                      2002 வாக்காளர் பட்டியலிலிருந்து வாக்காளர்களைத் தேட மேலே
                      உள்ள வடிப்பான்களைப் பயன்படுத்தவும்:
                    </p>
                    <ul className="list-disc list-inside space-y-2">
                      <li>
                        <span className="font-medium">வாக்காளர் பெயர்:</span>{" "}
                        வாக்காளர் பெயரால் தேடுங்கள் (தமிழ் மற்றும் ஆங்கிலம்
                        ஆதரிக்கப்படுகிறது)
                      </li>
                      <li>
                        <span className="font-medium">உறவினர் பெயர்:</span>{" "}
                        தந்தை/கணவர்/தாய் பெயரால் தேடுங்கள்
                      </li>
                      <li>
                        <span className="font-medium">பாலினம்:</span>{" "}
                        பாலினத்தால் வடிகட்டவும் (ஆண்/பெண்/மற்றவை)
                      </li>
                    </ul>
                    <p className="text-center mt-6 text-gray-500 italic">
                      குறைந்தபட்சம் ஒரு தேடல் அளவுகோலை உள்ளிட்டு தேடல்
                  ...
                  <div className="space-y-3 text-sm text-gray-600">
                    <p className="font-medium text-center mb-4">
                      Use the filters above to search for voters from the 2002
                      electoral roll:
                    </p>
                    <ul className="list-disc list-inside space-y-2">
                      <li>
                        <span className="font-medium">Elector Name:</span>{" "}
                        Search by elector name (supports Tamil and English)
                      </li>
                      <li>
                        <span className="font-medium">Relation Name:</span>{" "}
                        Search by father/husband/mother name
                      </li>
                      <li>
                        <span className="font-medium">Gender:</span> Filter by
                        gender (Male/Female/Other)
                      </li>
                    </ul>
                    <p className="text-center mt-6 text-gray-500 italic">
                      Enter at least one search criterion and click the Search
                      button
                    </p>
                  </div>
                </div>
            ...
            <div className="p-8 lg:p-12 text-center">
              <div className="max-w-md mx-auto">
                ...
                <p className="text-sm text-gray-600 mb-4">
                  We couldn&apos;t find any electors matching your search
                  criteria. Please try adjusting your filters or search terms.
                </p>
                <button
                  onClick={handleReset}
